...
During the project, AI tools such as ChatGPT, or Claude Code were used for \LaTeX formatting and troubleshooting code. Grammarly was used for grammar corrections. Those tools were not used to develop new code from scratch or write sections of this report. Screenshots of conversations with the large language models are provided in the project repository on GitHub. \todo{footnote}