...
\tod[inline]{From the \textit{Project Guide}: \\ Stability and control characteristics include e.g. control forces, CoG limits, attitude control torques, momentum storage and unload capacity, disturbance torques, control frequency, etc.\\
