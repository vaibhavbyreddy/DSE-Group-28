...
The control forces on each of the control surfaces were calculated using the Flow5 software.
\subsection{Flight conditions}
\subsection{Aileron control forces}
\subsection{Elevator control forces}
