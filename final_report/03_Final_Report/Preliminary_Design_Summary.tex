...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|c|c|}\hline
        \textbf{Parameter} & \textbf{Unit} & \textbf{Value} & \textbf{Source}  \\\hline
         ...
         Fuselage total skin panel thickness& mm &10.8 (.4-10-.4) & \autoref{sec:fuselage_structural_analysis} \\\hline
         ...
         Fuel required standard planform& kg & 6.884 & \\\hline
...
Having the system, subsystem sizing, emission-calculator (see \autoref{sec:emission_analysis}) and detailed flight profile it is possible modify the preliminary LCA to make the final LCA. The LCA consists of 4316 individual processes and with 52553 process links.
The diagram which can be found at (see Appendix A \autoref{fig:Final_LCA}) is just a small section of it. The full LCA can be found at (\footnote{\href{https://www.dropbox.com/scl/fi/ets1n8ow6bpw06mrl66y8/DSE-28-Final.zip?rlkey=k12clxdx1p1n44j69a3f6jt94&st=0nscvdv0&dl=0}{FinalLCA-download} }). 
