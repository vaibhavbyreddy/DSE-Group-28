...
The flight to the mission altitude would be performed using the aircraft's standard control system. Then, at the mission altitude and at the mission velocity, the control scheme will be switched to the researcher’s system. If the system begins to diverge and cause instability for any reason, the aircraft will automatically revert to the standard control scheme, using sensor data or manually by the ground crew. Otherwise, the experiment will continue as planned, and data will be collected.
