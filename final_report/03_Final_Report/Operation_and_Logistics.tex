...
\textit{Requirements for the base aircraft to be able to test this:} 
\begin{enumerate}
    \item A sensor that \textbf{can} be mounted at the front
    \item Wing loading sensors
    \item Fast enough actuators for what can be reasonably tested
\end{enumerate}
...
\textit{Requirements for the base aircraft to be able to test this:}
\begin{enumerate}
    \item Wing deflection sensor
    \item Wing twist sensor
\end{enumerate}
...
\textit{Requirements for the base aircraft to be able to test this:}
\begin{enumerate}
    \item Deflection and load sensors
    \item Swappable wing
\end{enumerate}
...
\textit{Requirements for the base aircraft to be able to test this:}
\begin{enumerate}
    \item Ability to add a canard
    \item Ability to house the additional electronics required for the canard
    \item Additional requirements based on the specifics of the experiment
\end{enumerate}

\textit{Special Accommodations:}
\begin{enumerate}
    \item Base control system that works with the specific configuration being tested
    \item Canard sensors
    \item Researcher’s control system addition
    \item Additional accommodations based on the specifics of the experiment
\end{enumerate}
...
\textit{Requirements for the base aircraft to be able to test this:}
\begin{enumerate}
    \item Swappable wings
    \item Ability to house the required sensors and data acquisition
    \item Wing load sensors
\end{enumerate}
...
\textit{Requirements for the base aircraft to be able to test this:}
\begin{enumerate}
    \item Swappable empennage that can accommodate a truss
    \item Wing deflection sensor
    \item Swappable wing that can accommodate a truss
\end{enumerate}

\textit{Special Accommodations:}
\begin{enumerate}
    \item Truss support for the main wing
    \item New wing
\end{enumerate}
