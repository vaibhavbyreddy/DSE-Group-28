...
Throughout the potential noise generated by HUGO was discussed. It was decided that if the noise generated by the aircraft exceed 120 decibels for any bystanders (within a vicinity of 50 meters), modifications would be implemented to mitigate the noise. The 120 decibels were chosen as the limit as it is at that point were short time exposure can lead to permanent hearing-damage (insert citation). Therefore the noise of the aircraft was modelled and calculated for the mission profile. 
