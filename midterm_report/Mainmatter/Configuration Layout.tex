...
Other outer characteristics include the doors for the internal components, placed in top of the fuselage, doors for the landing gear, both nose and main, camera ports and the fuel port. A sketch of the external configuration can be found in \autoref{fig:External_config}.

\begin{figure}
    \centering
    \includegraphics[width=0.6\linewidth]{figures/Sketches/Outer_Stuff.jpeg}
    \caption{External Configuration of HUGO}
    \label{fig:External_config}
\end{figure}
