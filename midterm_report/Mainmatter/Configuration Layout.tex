...
Other outer characteristics include the doors for the internal components, placed in top of the fuselage, doors for the landing gear, both nose and main, camera ports and the fuel port. A sketch of the external configuration can be found in 
...
The nose cone will house a weather radar, giving HUGO weather prediction capabilities, aiding in measuring the atmosphere parameters.
...
& Provides 3D measurements and view of the wing in real time via a laser pointing system. Will be placed in the nose of the cone. \\
\hline
...
Based on the preliminary aircraft sizing and requirements, the initially selected VULCAN engine is in an early development stage, and the figures regarding its overall propulsive efficiency are uncertain. \todo{good to refer to the actual section where this is said} Furthermore, small turbojet engines on the market can be easily integrated due to their known characteristics and availability of the supporting subsystems. Therefore, commercial turbojet engine candidates were considered. The industry-proven PBS TJ40-G2 engine \footnote{\href{https://pdf.aeroexpo.online/pdf/pbs-velka-bites/tj-40-g2-turbojet-engine/170284-304.html}{TJ-40-G2-Turbojet-Engine}} is selected as a candidate for a HUGO engine and is used as a reference component in \autoref{tab:prop_system}.\\

The turbojet engine needs several additional components to become operational. An ECU (Electronic Control Unit) is neccessary to correctly set the correct fuel mixture based on the thrust required and the fuel used. This unit is included inside the engine casing for the considered TJ40-G2 engine. Next, the fuel system consists of the fuel pump \footnote {\href{https://www.jetcat.de/en/productdetails/produkte/jetcat/produkte/zubehoer/Bus-Smokerpumpe}{JetCat fuel pump}(Accessed on 18.5.2026)}, fuel filter \footnote {\href{https://www.jetcat.de/en/productdetails/produkte/jetcat/produkte/zubehoer/Schlauchverbindung/Kraftstoff-Filter\%20mit\%20herausnehmbaren\%20Filtereinsatz}{JetCat fuel filter}(Accessed on 18.5.2026)}, shut-off valve and fuel distribution hoses. An overview of the propulsion system components is presented in \autoref{tab:prop_system} and a simple diagram of the subsystem relationships is shown in \autoref{fig:prop_diagram}. Since no available data about the TJ40-G2 fuel pump, fuel filter and power electronics board could be found, accessories from another manufacturer, JetCat, are used for reference. A slight margin has been added to the dimensions and weights of these components to generate a conservative estimate. The weight and dimensions of the power distribution system have been estimated based on a universal BMS. \footnote{\href{https://www.orionbms.com/downloads/documents/orionjr2_specifications.pdf}{Lithium Ion Battery Management
System}(Accessed on 18.5.2026)} Furthermore, 2 m of PTFE tube for fuel distribution is included.\footnote{\href{https://ptfetubeshop.com/en/product/ptfe-tube-4-mm-x-8-mm/?srsltid=AfmBOopcWd4OwpWvWxhcXm5ZaT8P1H2EP4Aw9Il2Rezb7qgHZba8-M9b}{PTFE tube 4 mm x 8 mm}(Accessed on 19.5.2026)}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|}
        ...
        Fuel tank & & \\
        \hline
        Fuel pump & 150 & 35 (diameter) x 80 (length)\\
        \hline
        Fuel filter & 20 & 25 (diameter) x 45 (length) \\
        \hline
...
\todo{The fuel tank has to come from the analysis}
...
Taking the tyre width mentioned in the previous sections, 45 mm with a diameter of 200, and adding 5 m to account for strut clearance and pins, each leg of the undercarriage will occupy a volume with a width of 50 mm and depth of 205 mm, based on the wheel diameter.
