...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{figures/HUGO_propulsion_diagram_260518.png}
...
Taking the tyre width mentioned in the previous sections of 45 mm with a diameter of 200 mm and adding 5 mm to account for strut clearance and pins, each leg of the undercarriage will occupy a volume of width of 50 mm and depth of 205 mm, based on the wheel diameter. The volume ocupoed by each leg is 0.001722 $m^2$, in total 0.005166 $m^2$ of internal volume occupied by the undercarriage.
