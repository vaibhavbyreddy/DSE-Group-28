...
The turbojet engine needs several additional components to become operational. An ECU (Electronic Control Unit) is neccessary to correctly set the correct fuel mixture based on the thrust set and the fuel used. This unit needs fit inside the fuselage. The same holds for the fuel pump, fuel filter, shut-off valve and fuel distribution hoses. An overview of the propulsion system components is presented in \autoref{tab:prop_system} and a simple diagram of the subsystem relationships is shown in \autoref{fig:prop_diagram}.
