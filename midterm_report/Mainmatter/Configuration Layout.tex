...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|}
        ...
        \textbf{Component} & \textbf{Weight [g]} & \textbf{Dimensions [mm]}  \\
        \hline\hline
        Engine: JetCat P100-RX-BL & 1080 & 97 (diameter) x 241 (length)\\
        \hline
        ECU (V10.0) & 26 & 55 x 36 x 18 (length x width x height) \\
        \hline
        ...
        \hline
        Fuel pump (Bus-system BL) & 110 & 31.5 (diameter) x 77 (length)\\
        \hline
        Fuel filter (Standard Inline) & 15 & 20 (diameter) x 45 (length) \\
        \hline
...
System}(Accessed on 18.5.2026)} Furthermore, 2m of PTFE tube for fuel distribution is added and a 3 gallon fuel bag are.\footnote{\href{https://ptfetubeshop.com/en/product/ptfe-tube-4-mm-x-8-mm/?srsltid=AfmBOopcWd4OwpWvWxhcXm5ZaT8P1H2EP4Aw9Il2Rezb7qgHZba8-M9b}{PTFE tube 4 mm x 8 mm}(Accessed on 19.5.2026)} This corresponds to the fuel mass estimated in \autoref{sec:trade-off_matrix}.


\todo{the below fig is unreadable, try to redo it by optimising the space between the boxes and the arrows' length}
\begin{figure}[H]
    \centering
