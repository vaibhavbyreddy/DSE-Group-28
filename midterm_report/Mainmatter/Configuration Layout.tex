...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/HUGO propulsion system control feedback diagram.png}
...
\begin{table}[H]
    ...
    \hline
        ...
        \hline \hline
         ...
         Gear height & 0.167 & Wheel diameter & 0.085 & Strut width
...
Taking the tyre width mentioned in the previous sections of 25 mm with a diameter of 85 mm and adding 5 mm to account for strut clearance and pins, each leg of the undercarriage will occupy a volume of width of 30 mm and depth of 90 mm, based on the wheel diameter. The total gear length length is calculated as the gear height plus the margin plus wheel radius to 214.5 mm. The volume occupied by each leg is 0.00057915 $m^3$, in total 0.0011583 $m^3$ of internal volume occupied by the undercarriage.
