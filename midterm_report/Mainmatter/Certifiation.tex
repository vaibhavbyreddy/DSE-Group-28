...
\subsection{Aircraft Capabilities (21.A.14)}
...
\subsection{Compliance with certification basis, operational suitability, environmental protection (21.A.20)}
...
Additionally, it will have to comply with 21.B.82: Operation Suitability; ??????. It will need to comply with 21.B.85: Applicable environmental protection requirements for a type certificate or restricted type certificate. However, specific rules for UAS are not indicated in 21.B.85, and thus will not be considered further. Moreover, inspections and testing compliance will be dictated by 21.A.33 and 21.A.35 respectively.

The special conditions detailed under the Special Condition for Light Unmanned Aircraft Systems - High Risk; entails extra requirements for: Design and Construction, Systems and Equipment, specifically relating to risk of failure, environmental hazards, robustness in the event of a lightning strike, and additional High Intensity Radiated Fields (HIRF) protection.


The application for the TC is detailed in 21.A.15. 21.A.15 states that (a) the TC application should be made in a form and manner established by EASA, (b) an application for a TC includes as a minimum a perliminary description of the UAS or the Control and Monitoring Unit (CMU), and the kind of operations for which certification is requested. In addition it shall comply with the aforementioned 21.A.20 consisting of the following:
...
Points 1 to 4 of 21.B.100(a) are as follows:
