...
According to the EASA eRules for Initial Airworthiness and Environmental Protection (eRules), the Type Certificate (TC) is a document issued by the competent authority declaring an aircraft meets all required airworthiness standards. The eRules describes the process and all necessary documents to obtain a type certificate. Section 21.A.21 states the requirements for the issuance of a TC. Namely, 21.A.14: the capabilities of the aircraft , 21.A.20: demonstration of compliance with the type certification
basis, operational suitability data certification basis and environmental protection requirements , and specifically for HUGO, 21.B.80: demonstration of compliance with UAS Type Certification basis. 

Starting with Annex I section 21.A.14, to demonstrate the design capabilities of the aircraft, HUGO must comply with 21.A.14(a), 21.A.14(b), 21.A.112B(b), or 21.A.432B(b). As HUGO is a UAS system, it will have to comply with 21.A.14(a) by obtaining a Design Organisatio Aproval (DOA) which will be explained in \autoref{sec: DOA}. Sections 21.A.14(b)-(c) as UAS aircraft fall outside their scope.

For compliance with 21.A.20, the HUGO design will have to demonstrate compliance with 21.B.80: type-certification basis for a type-certificate or restricted
type-certificate, leading to 21.B.75: Special conditions; detailing how projects falling outside the scope of the eRules should comply with regulation. Specifically, this is using the Special Condition for Light Unmanned Aircraft Systems - High Risk (CITATION). Additionally, it will have to comply with 21.B.82: Operation Suitability; ??????. It will need to comply with 21.B.85: Applicable environmental protection requirements for a type certificate or restricted type certificate. However, specific rules for UAS are not indicated in 21.B.85, and thus will not be considered further. Moreover, inspections and testing compliance will be dictated by 21.A.33 and 21.A.35 respectively.
...
\begin{enumerate}
    ...
    \item the intended use of the UAS, and the kind of operations for which certification is requested;
...
Environmental compatibility was introduced in the European legislation Regulation (EU) 2018/1139. The intention was to create a common framework for the environmental certification of aircraft. A large part of the regulation was based on the Chicago convention (insert reference here). HUGO is exempt for those rules as stated in recital 1 in REGULATION (EU) 2025/870: Aircraft , other than unmanned aircraft, and their engines, propellers,
parts and non-installed equipment should comply with the environmental
protection requirements. Regulation (EU) 2018/1139 provides for them by
referring to specific provisions of the Chicago Convention, which contain
those requirements.
\newline
A specific rules-set has been setup for unmanned aircraft COMMISSION DELEGATED REGULATION (EU) 2024/1108 in Annex 9: ESSENTIAL ENVIRONMENTAL REQUIREMENTS FOR UNMANNED AIRCRAFT
Unmanned aircraft shall comply with the environmental performance requirements set out in Annex III. The main point of annex is a general approach for the design and trade-off between minimising noise and emissions. The area and its sorroundings must also be taken into account for the operation      
