\chapter{Planning}
\label{ch:planning}
\todo[inline]{\textbf{Chapter under proofreading/maintenance by Hanna} - pls don't touch anything without telling me. So long as this TODO is here, things will move and disappear (only to manifest themselves again somewhere else). So if you want to add, modify, or delete something, let me know asap!}
...
Additional technical roles were defined to create focused engineering design departments. Each team member was assigned one organisational role and one technical role, and backup members were appointed for each department (names written in bold and italics). Other 
The Team Organogram is shown in \autoref{fig:organogram} in \autoref{sec:project_diagrams}.
