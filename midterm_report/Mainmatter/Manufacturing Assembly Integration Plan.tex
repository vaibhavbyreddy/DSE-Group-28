...
\begin{enumerate}
    \item \textbf{Forging}: it is the preferred process for the manufacturing of the primary landing gear components (outer cylinder and piston rod) \footnote{\href{https://www.aero-mag.com/why-additive-is-coming-into-landing-gear}{Why additive is coming into landing gear}}. Heated high-strength alloys are plastically deformed through the application of compressive forces using dies or plates to achieve the desired shape. In general, forging can be classified into two main categories \cite{Lorraine2024}:
    \begin{itemize}
    ...
    \item \textbf{Additive/Hybrid manufacturing}
\end{enumerate}
