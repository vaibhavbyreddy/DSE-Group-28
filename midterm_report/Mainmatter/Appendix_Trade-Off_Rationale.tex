...
\hline
\textbf{Material} & \textbf{Normalized} & \textbf{Normalized} & \textbf{Normalized} & \textbf{Normalized} & \textbf{Weighted} \\
\textbf{Candidate} & \textbf{Density} & \textbf{Specific} & \textbf{Specific} & \textbf{Specific} & \textbf{Score} \\
& & \textbf{Modulus} & \textbf{Strength} & \textbf{Toughness} & \\
 & ($w = 1.00$) & ($w = 0.75$) & ($w = 1.00$) & ($w = 0.25$) & \\
\hline\hline
Carbon/epoxy \newline (quasi-directional) & 0.235 & 1.000 & 1.000 & 0.723 & \textbf{2.166} \\\hline
Glass/epoxy \newline (quasi-directional)  & 0.200 & 0.976 & 0.853 & 1.000 & 2.035 \\\hline
Sitka spruce                 & 1.000 & 0.765 & 0.307 & 0.323 & 1.961 \\\hline
Steel alloy \newline (18Ni (350))     & 0.049 & 0.837 & 0.657 & 0.158 & 1.373 \\\hline
Ti alloy \newline (Ti-6Al-4V)         & 0.087 & 0.799 & 0.482 & 0.700 & 1.344 \\\hline
Al alloy \newline (7075 Al-T76)       & 0.148 & 0.881 & 0.387 & 0.345 & 1.282 \\\hline
Mg alloy \newline (WE46-T6)           & 0.235 & 0.901 & 0.260 & 0.381 & 1.266 \\
\hline
\end{tabular}
