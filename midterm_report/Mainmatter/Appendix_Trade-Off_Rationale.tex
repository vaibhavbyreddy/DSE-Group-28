...
\begin{table}[htbp]
    ...
    \begin{tabular}{lcccc}
        \toprule
        & \textbf{Norm. Modulus} & \textbf{Norm. Strength} & \textbf{Norm. Toughness} & \textbf{Weighted} \\
        \textbf{Material Candidate} & ($w = 0.75$) & ($w = 1.00$) & ($w = 0.25$) & \textbf{Score} \\
        \midrule
        Carbon/epoxy (quasi-directional) & 1.000 & 1.000 & 0.723 & \textbf{0.965} \\
        Glass/epoxy (quasi-directional)  & 0.976 & 0.853 & 1.000 & 0.918 \\
        Steel alloy (18Ni (350))         & 0.837 & 0.657 & 0.158 & 0.662 \\
        Ti alloy (Ti-6Al-4V)             & 0.799 & 0.482 & 0.700 & 0.628 \\
        Al alloy (7075 Al-T76)           & 0.881 & 0.387 & 0.345 & 0.567 \\
        Mg alloy (WE46-T6)               & 0.901 & 0.260 & 0.381 & 0.516 \\
        Sitka spruce                     & 0.765 & 0.307 & 0.323 & 0.481 \\
        \bottomrule
    \end{tabular}
    \vspace{0.5em}
    \raggedright
    \footnotesize{\textit{Note:} Final weighted scores are normalized by the sum of the weights ($\sum w = 2.00$) to maintain a standard dimensionless scale from 0.0 to 1.0.}
\end{table}
\todo[inline]{Fix table formatting}