...
\begin{enumerate}
    ...
    \item HUG-CFG-302: Static port results in minimal fatigue exposure; side podded landing gear ensures good accessibility enabling routine preventive maintenance — no anticipated failure — score 4
    \item HUG-CFG-303: Static ports result in minimal fatigue exposure; buried landing gear limits accessibility, though preventive maintenance remains feasible with planning — soft failure risk — score 3
...
\textbf{Cost}
\begin{enumerate}
    \item HUG-CFG-301: scores 2
    \item HUG-CFG-302: scores 4
    \item HUG-CFG-303: scores 3
    \item HUG-CFG-304: scores 2
    \item HUG-CFG-305: scores 2
\end{enumerate}
