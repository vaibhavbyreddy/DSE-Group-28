...
\begin{figure}[H]
    ...
    \caption{Initial HUGO configuration concepts 301 and 302}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/Sketches/HUG-CFG-304 no arrows.jpg}
        \caption{HUG-CFG-304: high wing, variable wing port, static canard port; with an example external instrument layout}
        \label{fig:hug-cfg-304-outer}
    \end{subfigure}

    \caption{Initial HUGO configuration concepts 303 and 304}
...
The clear overall winner is \textbf{HUG-CFG-303}, achieving the highest total score of \textbf{3.84}. HUG-CFG-301 is eliminated early in the evaluation due to failing to meet the minimum acceptable threshold in versatility.
...
The landing gear is a retractable configuration to minimise aerodynamic drag at high subsonic Mach numbers. This solution also avoids the additional mass and structural complexity associated with side-podded landing gear arrangements.
