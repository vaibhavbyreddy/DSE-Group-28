...
\todo{redo this table once landing gear dilemma is settled}
...
Versatility & HUG-CFG-301 is a low-wing concept that prevents the testing of truss-braced wing concepts, which was considered significant in conversations with NLR \todo{cite this as in conversation}. Similarly, HUG-CFG-302 prevents the testing of canard-dependent configurations, which limits the range of possible test scenarios.\\ \hline

Reliability & Variable wing ports in HUG-CFG-301, HUG-CFG-304, and HUG-CFG-305 introduce additional fatigue exposure at modular interfaces, increasing operational risk. Due to their high-wing configuration, the last 4 configurations exhibit reduced accessibility for maintenance operations. Moreover, the design of HUGO is subject to specific reliability requirements (see: HUG-STR-003 \footref{url:baseline_report}).\\ \hline

Cost & Variable wing ports featured in HUG-CFG-301, HUG-CFG-304, and HUG-CFG-05 significantly increase the design complexity and associated development, maintenance, and repair costs compared to no/static port configurations. 
...
\begin{itemize}
    \item \textbf{Versatility} is quantified as the range of experiments and stability conditions that can be tested with the given configuration. As mentioned above, a configuration that can not test canard and truss-braced wing configurations or has a static port will score lower.
...
\toprule
\textbf{Config Code} & \textbf{MTOM} & \textbf{T/W} & \textbf{Fuel Fraction} & \textbf{CD0 Cruise} & \textbf{CD0 Mach Max} & \textbf{CD0 Go Around} & \textbf{CD0 Takeoff} \\
\midrule
HUG-CFG-301 & 38.163 & 0.333 & 0.268 & 0.022 & 0.0219 & 0.022 & 0.226 \\
HUG-CFG-302 & 35.252 & 0.362 & 0.274 & 0.024 & 0.0235 & 0.024 & 0.290 \\
HUG-CFG-303 & 37.027 & 0.343 & 0.270 & 0.023 & 0.0224 & 0.023 & 0.220 \\
HUG-CFG-304 & 38.208 & 0.334 & 0.268 & 0.022 & 0.0219 & 0.022 & 0.267 \\
...
The clear overall winner is \textbf{HUG-CFG-303}, achieving the highest total score of \textbf{3.9356}. HUG-CFG-301 and HUG-CFG-305 are eliminated early in the evaluation due to failing to meet the minimum acceptable thresholds in versatility and reliability, respectively.
...
Reliability is inversely correlated with system complexity and ease of maintenance. Consequently, configurations with variable ports and increased modularity tend to perform worse in this category. HUG-CFG-304 and HUG-CFG-305 receive the lowest reliability scores, a consequence of their high degree of modularity and the restricted maintenance access imposed by their high-wing configuration. HUG-CFG-301 benefits from the improved maintenance accessibility of a low-wing configuration, earning a slightly higher reliability score. In contrast, HUG-CFG-302 and HUG-CFG-303 achieve the highest reliability scores due to their comparatively simpler and more constrained architectures.
