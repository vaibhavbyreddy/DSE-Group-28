...
Versatility & HUG-CFG-301 is a low wing concept, which prevents the testing of tuss based wing concepts, which was considered significant in conversations with NLR. Similarly, HUG-CFG-302 prevents the testing of canard-dependent configurations, which limits the range of possible test scenarios, including the testing of canard configurations and mounting scaled wing models in front of the main planform.\\ \hline

Reliability & Variable wing ports featured in HUG-CFG-301, HUG-CFG-304, and HUG-CFG-305 significantly increase the design complexity and associated development and operational risks. The same reasoning can be applied for retractable side podded landing gear mechanisms for HUG-CFG-301, HUG-CFG-303, and HUG-CFG-305. Moreover, the design of HUGO is subject to specific reliability requirements (see: HUG-STR-003 \cite{BaselineReport}).\\ \hline
...
\label{tab:trade-off_criteria_materials} \\
...
Sustainability & Sustainability of the manufacturing of HUGO must be considered when choosing suitable materials. Standing at the forefront of aviation research, HUGO shall embrace the mission to lower the industry's environmental impact.
\\ \hline
...
\begin{itemize}
    ...
    \item \textbf{Sustainability (Weight 0.5):} Standing at the forefront of modern aviation research, HUGO shall embrace the industry's movement towards sustainable solutions. At the same time, however, the main design focus is the ability of HUGO to perform its mission. For these reasons, this criterion was assigned a weight of 0.5
...
\end{table}\color{white}\textbf{Total} \\
\hline
