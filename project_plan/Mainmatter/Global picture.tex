...
\begin{table}[H]
    ...
    \begin{tabular}{|c|p{13cm}|}
        ...
        \hline
        \textbf{TBD-Usr-STR-1} & The aircraft shall accommodate payload experiments of total mass up to 5 kg.\\
        \hline
        \textbf{TBD-Usr-STR-2} & The aircraft shall be able to accommodate additional, experiment-dedicated electronics, included in payload mass, with a \textbf{TBD} volume.\\
        \hline
        ...
        \hline
        \textbf{TBD-Usr-AER-1} & The user shall be able to configure the aircraft for stable, neutral and unstable flight conditions. \\ 
        \hline
        \textbf{TBD-Usr-AER-2} & The critical Mach number of the aircraft's wing shall be higher than Mach 0.75.\\ \hline
        \textbf{TBD-Usr-AER-3} & The aircraft shall be able to house experimental planforms of \textbf{TBD} maximum horizontal surface \textbf{TBD} maximum vertical aerodynamic surface, and minimum L/D of \textbf{TBD}\\
        \hline

        % Control (CTL)
        \multicolumn{2}{|c|}{\textbf{Control (CTL)}} \\
        \hline
        \textbf{TBD-Usr-CTL-1} & The aircraft shall be controllable remotely from ground.\\ \hline
        \textbf{TBD-Usr-CTL-2} & The aircraft shall be able to conduct the in-flight experiments fully autonomously.\\
        \hline
        ...
        \hline
        \textbf{TBD-Usr-MIS-3} & Within the mission time, for \textbf{TBD < 30min}, the aircraft must be able to sustain the airspeed of Mach 0.75. \\
        \hline
        ...
        \hline
        \textbf{TBD-Usr-OPS-1} & The user shall be able to transport the aircraft in a van-sized vehicle. Exact dimensions \textbf{TBD}\\
        \hline
