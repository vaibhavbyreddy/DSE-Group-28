...
\begin{table}[H]
    ...
    \begin{tabular}{|c|p{13cm}|}
        ...
        \hline
        \textbf{HUG-Usr-STR-2} & The aircraft shall be able to accommodate additional, experiment-dedicated electronics, included in payload mass, with a \textbf{TBD} volume.\\
        \hline
        ...
        \hline
        \textbf{HUG-Usr-AER-2} & The critical Mach number of the aircraft's wing shall be higher than Mach 0.75.\\ \hline
        \textbf{HUG-Usr-AER-3} & The aircraft shall be able to house experimental planforms of \textbf{TBD} maximum horizontal surface \textbf{TBD} maximum vertical aerodynamic surface, and minimum L/D of \textbf{TBD}\\
        \hline
        ...
        \hline
        \textbf{HUG-Usr-MIS-3} & Within the mission time, for \textbf{TBD < 30min}, the aircraft must be able to sustain the airspeed of Mach 0.75. \\
        \hline
        ...
        \hline
        \textbf{HUG-Usr-OPS-1} & The user shall be able to transport the aircraft in a van-sized vehicle. Exact dimensions \textbf{TBD}\\
        \hline
