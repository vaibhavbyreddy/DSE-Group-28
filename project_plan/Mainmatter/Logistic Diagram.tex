...
\begin{figure}[H]
    ...
    \caption{Work Flow Diagram for Baseline Review}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.4\linewidth, angle=90]{figures/Work-flow final.png}
    \caption{Work Flow Diagram for Final Review}
