...
The final deliverable of the baseline report are going to be the few most feasible configurations of the aircraft. In order to achieve this, the workflow diagram is made to plan the sequence of activities. Colours are used to identify each work-packages which are natively interdependent and connected. The lightness of the colours signify the order of work-packages. The lightest groups should be completed first     
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.7\linewidth, angle=90]{figures/Work-flow baseline.pdf}
